...
proc create_hier_cell_other_perph { parentCell nameHier } {
  ...
  connect_bd_net -net s_axi_aresetn_1 [get_bd_pins s_axi_aresetn] [get_bd_pins reset_invert_led/Op1] [get_bd_pins axi_timer_1/s_axi_aresetn]
