...
\
  ...
  connect_bd_intf_net -intf_net Conn6 [get_bd_intf_pins ps_axi_periph/M02_AXI] [get_bd_intf_pins M02_AXI]
  connect_bd_intf_net -intf_net S00_AXI_1 [get_bd_intf_pins ps_axi_periph/S00_AXI] [get_bd_intf_pins zynq_ultra_ps_e_0/M_AXI_HPM0_FPD]
  ...
  connect_bd_intf_net -intf_net zynq_ultra_ps_e_0_M_AXI_HPM1_FPD [get_bd_intf_pins ps_axi_periph/S01_AXI] [get_bd_intf_pins zynq_ultra_ps_e_0/M_AXI_HPM1_FPD]
  ...
  connect_bd_net -net rst_ps8_0_99M_interconnect_aresetn [get_bd_pins rst_ps8_0_99M/interconnect_aresetn] [get_bd_pins axi_pl_ps/ARESETN] [get_bd_pins ps_axi_periph/ARESETN]
  ...
  connect_bd_net -net rst_ps8_0_99M_peripheral_reset [get_bd_pins rst_ps8_0_99M/peripheral_reset] [get_bd_pins peripheral_reset]
  connect_bd_net -net util_vector_logic_0_Res [get_bd_pins util_vector_logic_0/Res] [get_bd_pins Res]
  connect_bd_net -net xlconcat_0_dout [get_bd_pins xlconcat_0/dout] [get_bd_pins zynq_ultra_ps_e_0/pl_ps_irq0]
  connect_bd_net -net zynq_ultra_ps_e_0_pl_clk0 [get_bd_pins zynq_ultra_ps_e_0/pl_clk0] [get_bd_pins pl_clk0] [get_bd_pins rst_ps8_0_99M/slowest_sync_clk] [get_bd_pins axi_pl_ps/ACLK] [get_bd_pins axi_pl_ps/S00_ACLK] [get_bd_pins axi_pl_ps/M00_ACLK] [get_bd_pins ps_axi_periph/ACLK] [get_bd_pins ps_axi_periph/S00_ACLK] [get_bd_pins ps_axi_periph/S01_ACLK] [get_bd_pins ps_axi_periph/M00_ACLK] [get_bd_pins ps_axi_periph/M01_ACLK] [get_bd_pins ps_axi_periph/M02_ACLK] [get_bd_pins zynq_ultra_ps_e_0/maxihpm0_fpd_aclk] [get_bd_pins zynq_ultra_ps_e_0/maxihpm1_fpd_aclk] [get_bd_pins zynq_ultra_ps_e_0/saxihp0_fpd_aclk]
  connect_bd_net -net zynq_ultra_ps_e_0_pl_resetn0 [get_bd_pins zynq_ultra_ps_e_0/pl_resetn0] [get_bd_pins rst_ps8_0_99M/ext_reset_in] [get_bd_pins util_vector_logic_0/Op1]
...
proc create_root_design { parentCell } {
  ...
  set_property CONFIG.CONST_VAL {1} $sfp_tx_dis
  ...
  connect_bd_intf_net -intf_net zups_M02_AXI [get_bd_intf_pins axi_gpio_0/S_AXI] [get_bd_intf_pins zups/M02_AXI]

  # Create port connections
  connect_bd_net -net Net [get_bd_pins xxv_ethernet_0/rx_clk_out_0] [get_bd_pins zups/S02_ACLK] [get_bd_pins axi_dma_0/m_axi_s2mm_aclk] [get_bd_pins rx_data_fifo/s_axis_aclk] [get_bd_pins xxv_ethernet_0/rx_core_clk_0]
  connect_bd_net -net Net1 [get_bd_pins zups/pl_clk0] [get_bd_pins axi_dma_0/s_axi_lite_aclk] [get_bd_pins axi_dma_0/m_axi_sg_aclk] [get_bd_pins xxv_ethernet_0/dclk] [get_bd_pins xxv_ethernet_0/s_axi_aclk_0] [get_bd_pins axi_gpio_0/s_axi_aclk]
  connect_bd_net -net Net2 [get_bd_pins xlconstant_2/dout] [get_bd_pins xxv_ethernet_0/txoutclksel_in_0] [get_bd_pins xxv_ethernet_0/rxoutclksel_in_0]
  ...
  connect_bd_net -net axi_gpio_0_gpio_io_o [get_bd_pins axi_gpio_0/gpio_io_o] [get_bd_pins xxv_ethernet_0/qpllreset_in_0]
  ...
  connect_bd_net -net tx_rst_n_Res [get_bd_pins rx_rst_n/Res] [get_bd_pins zups/S02_ARESETN] [get_bd_pins rx_data_fifo/s_axis_aresetn]
  connect_bd_net -net util_vector_logic_0_Res [get_bd_pins tx_rst_n/Res] [get_bd_pins zups/S01_ARESETN] [get_bd_pins tx_data_fifo/s_axis_aresetn]
  connect_bd_net -net xlconstant_0_dout [get_bd_pins xlconstant_0/dout] [get_bd_pins xxv_ethernet_0/tx_preamblein_0]
  connect_bd_net -net xlconstant_1_dout [get_bd_pins xlconstant_1/dout] [get_bd_pins xxv_ethernet_0/ctl_tx_send_rfi_0] [get_bd_pins xxv_ethernet_0/ctl_tx_send_lfi_0] [get_bd_pins xxv_ethernet_0/ctl_tx_send_idle_0]
  connect_bd_net -net xlconstant_2_dout [get_bd_pins sfp_tx_dis/dout] [get_bd_ports sfp_tx_dis]
  connect_bd_net -net xxv_ethernet_0_tx_clk_out_0 [get_bd_pins xxv_ethernet_0/tx_clk_out_0] [get_bd_pins zups/S01_ACLK] [get_bd_pins axi_dma_0/m_axi_mm2s_aclk] [get_bd_pins tx_data_fifo/s_axis_aclk]
  ...
  connect_bd_net -net zups_Res [get_bd_pins zups/Res] [get_bd_pins xxv_ethernet_0/gtwiz_reset_tx_datapath_0] [get_bd_pins xxv_ethernet_0/gtwiz_reset_rx_datapath_0]
  connect_bd_net -net zups_peripheral_aresetn [get_bd_pins zups/peripheral_aresetn] [get_bd_pins axi_dma_0/axi_resetn] [get_bd_pins xxv_ethernet_0/s_axi_aresetn_0] [get_bd_pins axi_gpio_0/s_axi_aresetn]
  connect_bd_net -net zups_peripheral_reset [get_bd_pins zups/peripheral_reset] [get_bd_pins xxv_ethernet_0/sys_reset]
  ...
  assign_bd_address -offset 0xA0000000 -range 0x00010000 -target_address_space [get_bd_addr_spaces zups/zynq_ultra_ps_e_0/Data] [get_bd_addr_segs axi_dma_0/S_AXI_LITE/Reg] -force
  assign_bd_address -offset 0xA0010000 -range 0x00010000 -target_address_space [get_bd_addr_spaces zups/zynq_ultra_ps_e_0/Data] [get_bd_addr_segs axi_gpio_0/S_AXI/Reg] -force
  assign_bd_address -offset 0xA0040000 -range 0x00040000 -target_address_space [get_bd_addr_spaces zups/zynq_ultra_ps_e_0/Data] [get_bd_addr_segs xxv_ethernet_0/s_axi_0/Reg] -force

  # Exclude Address Segments
  exclude_bd_addr_seg -offset 0x000800000000 -range 0x000100000000 -target_address_space [get_bd_addr_spaces axi_dma_0/Data_MM2S] [get_bd_addr_segs zups/zynq_ultra_ps_e_0/SAXIGP2/HP0_DDR_HIGH]
  ...
  exclude_bd_addr_seg -offset 0x000800000000 -range 0x000100000000 -target_address_space [get_bd_addr_spaces axi_dma_0/Data_S2MM] [get_bd_addr_segs zups/zynq_ultra_ps_e_0/SAXIGP2/HP0_DDR_HIGH]
  exclude_bd_addr_seg -offset 0x000800000000 -range 0x000100000000 -target_address_space [get_bd_addr_spaces axi_dma_0/Data_SG] [get_bd_addr_segs zups/zynq_ultra_ps_e_0/SAXIGP2/HP0_DDR_HIGH]
