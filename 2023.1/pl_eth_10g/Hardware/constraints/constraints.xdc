...
#sfp2
set_property PACKAGE_PIN B2 [get_ports gt_rtl_grx_p]
set_property PACKAGE_PIN B1 [get_ports gt_rtl_grx_n]
set_property PACKAGE_PIN B6 [get_ports gt_rtl_gtx_p]
set_property PACKAGE_PIN B5 [get_ports gt_rtl_gtx_n]
