...
if { ${design_name} eq "" } {
  ...
  set_property USER_COMMENTS.comment_3 "PS-EMIO 1000BASE-X ETHERNET" [get_bd_designs $design_name]
  set_property USER_COMMENTS.comment_4 "PS-EMIO 1000BASE-X ETHERNET" [get_bd_designs $design_name]
  set_property USER_COMMENTS.comment_5 "PS-EMIO 1000BASE-X ETHERNET" [get_bd_designs $design_name]
  set_property USER_COMMENTS.comment_6 "PS-EMIO 1000BASE-X ETHERNET" [get_bd_designs $design_name]
...
\
  ...
  # Create port connections
  connect_bd_net -net Net  [get_bd_pins constants/config_valid] \
  ...
  connect_bd_net -net Net1  [get_bd_pins zynq_ultra_ps_e_0/emio_enet0_mdio_mdc] \
  [get_bd_pins c_counter_binary_1/CLK] \
  [get_bd_pins gig_ethernet_pcs_pma_0/mdc]
  connect_bd_net -net Net2  [get_bd_pins zynq_ultra_ps_e_0/emio_gpio_o] \
  ...
  connect_bd_net -net gig_ethernet_pcs_pma_0_gmii_rxclk  [get_bd_pins gig_ethernet_pcs_pma_0/gmii_rxclk] \
  [get_bd_pins c_counter_binary_2/CLK] \
  [get_bd_pins zynq_ultra_ps_e_0/emio_enet0_gmii_rx_clk]
  connect_bd_net -net gig_ethernet_pcs_pma_0_resetdone  [get_bd_pins gig_ethernet_pcs_pma_0/resetdone] \
  [get_bd_ports xcvr_rst_done_led]
  ...
  connect_bd_net -net gig_ethernet_pcs_pma_0_userclk2_out  [get_bd_pins gig_ethernet_pcs_pma_0/userclk2_out] \
  [get_bd_pins c_counter_binary_0/CLK]
  connect_bd_net -net xlconstant_0_dout  [get_bd_pins constants/phy_addr] \
  [get_bd_pins gig_ethernet_pcs_pma_0/phyaddr]
  connect_bd_net -net xlconstant_0_dout1  [get_bd_pins xlslice_5/Dout] \
  [get_bd_ports pl_reset_led] \
  [get_bd_pins gig_ethernet_pcs_pma_0/reset]
  connect_bd_net -net xlconstant_2_dout  [get_bd_pins constants/config_vector] \
  [get_bd_pins gig_ethernet_pcs_pma_0/configuration_vector]
  connect_bd_net -net xlconstant_3_dout  [get_bd_pins constants/an_adv_config_vec] \
  [get_bd_pins gig_ethernet_pcs_pma_0/an_adv_config_vector]
  connect_bd_net -net xlconstant_4_dout  [get_bd_pins constants/signal_detect] \
  [get_bd_pins gig_ethernet_pcs_pma_0/signal_detect]
  connect_bd_net -net xlconstant_5_dout  [get_bd_pins constants/sfp_tx_dis] \
  [get_bd_ports sfp_tx_dis]
  connect_bd_net -net xlslice_0_Dout  [get_bd_pins xlslice_0/Dout] \
  [get_bd_ports pcs_clk_led]
