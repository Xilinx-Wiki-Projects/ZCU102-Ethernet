...
\
  ...
  # Create port connections
  connect_bd_net -net ACLK_1  [get_bd_pins zusp_ps/pl_clk0] \
  [get_bd_pins clk_75] \
  ...
  [get_bd_pins ps_rst_75/slowest_sync_clk] \
  [get_bd_pins zusp_ps/maxihpm0_fpd_aclk] \
  [get_bd_pins zusp_ps/maxihpm1_fpd_aclk] \
  [get_bd_pins zusp_ps/saxihp0_fpd_aclk]
  connect_bd_net -net ARESETN_1  [get_bd_pins ps_rst_75/interconnect_aresetn] \
  [get_bd_pins axi_pl_ps/ARESETN] \
  [get_bd_pins ps_axi_periph/ARESETN]
  connect_bd_net -net In0_1  [get_bd_pins In0] \
  [get_bd_pins ps_irq_concat/In0]
  connect_bd_net -net In1_1  [get_bd_pins In1] \
  [get_bd_pins ps_irq_concat/In1]
  connect_bd_net -net In2_1  [get_bd_pins In2] \
  [get_bd_pins ps_irq_concat/In2]
  connect_bd_net -net In3_1  [get_bd_pins In3] \
  [get_bd_pins ps_irq_concat/In3]
  connect_bd_net -net M00_ARESETN_1  [get_bd_pins ps_rst_75/peripheral_aresetn] \
  [get_bd_pins perph_aresetn_75] \
  ...
  connect_bd_net -net ps_irq_concat_dout  [get_bd_pins ps_irq_concat/dout] \
  [get_bd_pins zusp_ps/pl_ps_irq0]
  connect_bd_net -net ps_rst_75_peripheral_reset  [get_bd_pins ps_rst_75/peripheral_reset] \
  [get_bd_pins peripheral_reset]
  connect_bd_net -net zusp_ps_pl_clk1  [get_bd_pins zusp_ps/pl_clk1] \
  [get_bd_pins clk_50]
  connect_bd_net -net zusp_ps_pl_resetn0  [get_bd_pins zusp_ps/pl_resetn0] \
  [get_bd_pins ps_rst_75/ext_reset_in]
...
proc create_hier_cell_other_perph { parentCell nameHier } {
  ...
  # Create port connections
  connect_bd_net -net CLK1_1  [get_bd_pins CLK1] \
  ...
  connect_bd_net -net sfp_tx_disable_dout  [get_bd_pins sfp_tx_disable/dout] \
  [get_bd_pins dout]
...
proc create_root_design { parentCell } {
  ...
  # Create port connections
  connect_bd_net -net axi_eth_0_dma_mm2s_cntrl_reset_out_n  [get_bd_pins axi_eth_0_dma/mm2s_cntrl_reset_out_n] \
  [get_bd_pins axi_eth_0/axi_txc_arstn]
  connect_bd_net -net axi_eth_0_dma_mm2s_introut  [get_bd_pins axi_eth_0_dma/mm2s_introut] \
  [get_bd_pins zynq_ps/In0]
  connect_bd_net -net axi_eth_0_dma_mm2s_prmry_reset_out_n  [get_bd_pins axi_eth_0_dma/mm2s_prmry_reset_out_n] \
  [get_bd_pins axi_eth_0/axi_txd_arstn]
  connect_bd_net -net axi_eth_0_dma_s2mm_introut  [get_bd_pins axi_eth_0_dma/s2mm_introut] \
  [get_bd_pins zynq_ps/In1]
  connect_bd_net -net axi_eth_0_dma_s2mm_prmry_reset_out_n  [get_bd_pins axi_eth_0_dma/s2mm_prmry_reset_out_n] \
  [get_bd_pins axi_eth_0/axi_rxd_arstn]
  connect_bd_net -net axi_eth_0_dma_s2mm_sts_reset_out_n  [get_bd_pins axi_eth_0_dma/s2mm_sts_reset_out_n] \
  [get_bd_pins axi_eth_0/axi_rxs_arstn]
  connect_bd_net -net axi_eth_0_interrupt  [get_bd_pins axi_eth_0/interrupt] \
  [get_bd_pins zynq_ps/In2]
  connect_bd_net -net axi_eth_0_rxuserclk2_out  [get_bd_pins axi_eth_0/rxuserclk2_out] \
  [get_bd_pins other_perph/CLK]
  connect_bd_net -net axi_eth_0_userclk2_out  [get_bd_pins axi_eth_0/userclk2_out] \
  [get_bd_pins other_perph/CLK1]
  connect_bd_net -net other_perph_Dout1  [get_bd_pins other_perph/Dout1] \
  [get_bd_ports rx_clk_led]
  connect_bd_net -net other_perph_Dout2  [get_bd_pins other_perph/Dout2] \
  [get_bd_ports mgt_clk_led]
  connect_bd_net -net other_perph_Dout3  [get_bd_pins other_perph/Dout3] \
  [get_bd_ports axi_lite_clk_led]
  connect_bd_net -net other_perph_Res  [get_bd_pins other_perph/Res] \
  [get_bd_ports axil_reset_led]
  connect_bd_net -net other_perph_dout  [get_bd_pins other_perph/dout] \
  [get_bd_ports sfp_tx_dis]
  connect_bd_net -net other_perph_interrupt  [get_bd_pins other_perph/interrupt] \
  [get_bd_pins zynq_ps/In3]
  connect_bd_net -net s_axi_aclk_1  [get_bd_pins zynq_ps/clk_75] \
  [get_bd_pins other_perph/s_axi_aclk] \
  [get_bd_pins axi_eth_0/s_axi_lite_clk] \
  [get_bd_pins axi_eth_0/axis_clk] \
  [get_bd_pins axi_eth_0_dma/s_axi_lite_aclk] \
  [get_bd_pins axi_eth_0_dma/m_axi_sg_aclk] \
  [get_bd_pins axi_eth_0_dma/m_axi_mm2s_aclk] \
  [get_bd_pins axi_eth_0_dma/m_axi_s2mm_aclk]
  connect_bd_net -net s_axi_aresetn_1  [get_bd_pins zynq_ps/perph_aresetn_75] \
  [get_bd_pins other_perph/s_axi_aresetn] \
  [get_bd_pins axi_eth_0/s_axi_lite_resetn] \
  [get_bd_pins axi_eth_0_dma/axi_resetn]
  connect_bd_net -net zynq_ps_clk_50  [get_bd_pins zynq_ps/clk_50] \
  [get_bd_pins axi_eth_0/ref_clk]
