...
\
  ...
  [get_bd_pins axi_pl_ps/S01_ACLK]
  connect_bd_net -net S01_ARESETN_1  [get_bd_pins S01_ARESETN] \
  [get_bd_pins axi_pl_ps/S01_ARESETN]
  connect_bd_net -net S02_ACLK_1  [get_bd_pins S02_ACLK] \
  [get_bd_pins axi_pl_ps/S02_ACLK]
  connect_bd_net -net S02_ARESETN_1  [get_bd_pins S02_ARESETN] \
  [get_bd_pins axi_pl_ps/S02_ARESETN]
  connect_bd_net -net rst_ps8_0_99M_interconnect_aresetn  [get_bd_pins rst_ps8_0_99M/interconnect_aresetn] \
  [get_bd_pins axi_pl_ps/ARESETN] \
  ...
  [get_bd_pins axi_pl_ps/S00_ARESETN] \
  [get_bd_pins axi_pl_ps/M00_ARESETN] \
  [get_bd_pins ps_axi_periph/S00_ARESETN] \
  [get_bd_pins ps_axi_periph/S01_ARESETN] \
  ...
  [get_bd_pins pl_clk0] \
  [get_bd_pins axi_pl_ps/ACLK] \
  [get_bd_pins axi_pl_ps/S00_ACLK] \
  [get_bd_pins axi_pl_ps/M00_ACLK] \
  [get_bd_pins ps_axi_periph/ACLK] \
  [get_bd_pins ps_axi_periph/S00_ACLK] \
  [get_bd_pins ps_axi_periph/S01_ACLK] \
...
proc create_root_design { parentCell } {
  ...
  # Create port connections
  connect_bd_net -net Net  [get_bd_pins xxv_ethernet_0/rx_clk_out_0] \
  [get_bd_pins zups/S02_ACLK] \
  [get_bd_pins axi_dma_0/m_axi_s2mm_aclk] \
  [get_bd_pins rx_data_fifo/s_axis_aclk] \
  [get_bd_pins xxv_ethernet_0/rx_core_clk_0]
  connect_bd_net -net Net1  [get_bd_pins zups/pl_clk0] \
  [get_bd_pins axi_dma_0/s_axi_lite_aclk] \
  [get_bd_pins axi_dma_0/m_axi_sg_aclk] \
  [get_bd_pins axi_gpio_0/s_axi_aclk] \
  [get_bd_pins xxv_ethernet_0/dclk] \
  [get_bd_pins xxv_ethernet_0/s_axi_aclk_0]
  connect_bd_net -net Net2  [get_bd_pins xlconstant_2/dout] \
  [get_bd_pins xxv_ethernet_0/txoutclksel_in_0] \
  [get_bd_pins xxv_ethernet_0/rxoutclksel_in_0]
  connect_bd_net -net axi_dma_0_mm2s_introut  [get_bd_pins axi_dma_0/mm2s_introut] \
  [get_bd_pins zups/In0]
  ...
  [get_bd_pins xxv_ethernet_0/qpllreset_in_0]
  connect_bd_net -net dma_rx_rst_Res  [get_bd_pins dma_rx_rst/Res] \
  [get_bd_pins xxv_ethernet_0/rx_reset_0]
  connect_bd_net -net dma_tx_rst_Res  [get_bd_pins dma_tx_rst/Res] \
  [get_bd_pins xxv_ethernet_0/tx_reset_0]
  connect_bd_net -net tx_rst_n_Res  [get_bd_pins rx_rst_n/Res] \
  [get_bd_pins zups/S02_ARESETN] \
  [get_bd_pins rx_data_fifo/s_axis_aresetn]
  connect_bd_net -net util_vector_logic_0_Res  [get_bd_pins tx_rst_n/Res] \
  [get_bd_pins zups/S01_ARESETN] \
  [get_bd_pins tx_data_fifo/s_axis_aresetn]
  connect_bd_net -net xlconstant_0_dout  [get_bd_pins xlconstant_0/dout] \
  [get_bd_pins xxv_ethernet_0/tx_preamblein_0]
  connect_bd_net -net xlconstant_1_dout  [get_bd_pins xlconstant_1/dout] \
  [get_bd_pins xxv_ethernet_0/ctl_tx_send_rfi_0] \
  [get_bd_pins xxv_ethernet_0/ctl_tx_send_lfi_0] \
  [get_bd_pins xxv_ethernet_0/ctl_tx_send_idle_0]
  connect_bd_net -net xlconstant_2_dout  [get_bd_pins sfp_tx_dis/dout] \
  [get_bd_ports sfp_tx_dis]
  connect_bd_net -net xxv_ethernet_0_tx_clk_out_0  [get_bd_pins xxv_ethernet_0/tx_clk_out_0] \
  [get_bd_pins zups/S01_ACLK] \
  [get_bd_pins axi_dma_0/m_axi_mm2s_aclk] \
  [get_bd_pins tx_data_fifo/s_axis_aclk]
  connect_bd_net -net xxv_ethernet_0_user_rx_reset_0  [get_bd_pins xxv_ethernet_0/user_rx_reset_0] \
  [get_bd_pins rx_rst_n/Op1]
  connect_bd_net -net xxv_ethernet_0_user_tx_reset_0  [get_bd_pins xxv_ethernet_0/user_tx_reset_0] \
  [get_bd_pins tx_rst_n/Op1]
  connect_bd_net -net zups_Res  [get_bd_pins zups/Res] \
  [get_bd_pins xxv_ethernet_0/gtwiz_reset_tx_datapath_0] \
  [get_bd_pins xxv_ethernet_0/gtwiz_reset_rx_datapath_0]
  connect_bd_net -net zups_peripheral_aresetn  [get_bd_pins zups/peripheral_aresetn] \
  [get_bd_pins axi_dma_0/axi_resetn] \
  [get_bd_pins axi_gpio_0/s_axi_aresetn] \
  [get_bd_pins xxv_ethernet_0/s_axi_aresetn_0]
  connect_bd_net -net zups_peripheral_reset  [get_bd_pins zups/peripheral_reset] \
  [get_bd_pins xxv_ethernet_0/sys_reset]
